...
//	inline bool fuzzyRealEqual(const float& lhs, const float& rhs, const float& epsilon = MathEngine::Constant::FLOAT_TOLERANCE)
//	{
...
//	{
//		return angle * MathEngine::Constant::PI / 180.f;
//	}
//	// 라디안(rad)에서 도(°)로
//	inline float RADIAN_TO_DEGREE(const float angle)
//	{
//		return angle * 180.f / MathEngine::Constant::PI;
//	}
//}